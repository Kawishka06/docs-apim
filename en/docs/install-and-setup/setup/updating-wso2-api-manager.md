...
!!! warning
    ...
    **Persisting WSO2CarbonDB**
    ...
    !!! tip
        ...
        Take a backup of `<API-M_HOME>/repository/database/WSO2METRICS_DB.h2.db` and replace it in the updated API Manager distribution under `<API-M_HOME>/repository/database` directory that is updated.
